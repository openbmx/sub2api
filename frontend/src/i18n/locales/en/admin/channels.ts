export default {
    ...
    riskControl: {
      ...
      ipAccess: {
        ...
        save: 'Save',
        saving: 'Saving...',
        saved: 'IP access control settings saved',
        loadFailed: 'Failed to load IP access control settings',
        saveFailed: 'Failed to save IP access control settings',
        blacklistTitle: 'IP / CIDR blacklist',
        blacklistHint: 'Requests from blacklisted IPs receive 403 on every endpoint.',
        blacklistPlaceholder: 'One entry per line. Single IPs and CIDR ranges are supported, e.g.:\n1.2.3.4\n10.0.0.0/8\n2001:db8::/32',
        blockMessage: 'Custom block message (403 response content)',
        blacklistMessagePlaceholder: 'Leave empty to use the default message',
        ipv6Title: 'IPv6 blocking',
        ipv6Hint: 'When enabled, public IPv6 clients cannot register and gateway API calls return 403 (panel login is unaffected).',
        ipv6MessagePlaceholder: 'Leave empty to use the default message',
        ipv6Note: 'Only public IPv6 is blocked; loopback, link-local and private ULA addresses are unaffected.',
        selfLockConfirm: 'Warning: your current admin IP matches this blacklist — saving will lock you out too. Force save anyway?'
      },
