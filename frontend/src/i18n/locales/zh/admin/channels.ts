export default {
    ...
    riskControl: {
      ...
      ipAccess: {
        title: 'IP 访问控制',
        description: 'IP/IP 段黑名单与 IPv6 拦截，保存后约 5 秒内全局生效（独立于内容审计开关）。',
        save: '保存',
        saving: '保存中...',
        saved: 'IP 访问控制配置已保存',
        loadFailed: '加载 IP 访问控制配置失败',
        saveFailed: '保存 IP 访问控制配置失败',
        blacklistTitle: 'IP/IP 段黑名单',
        blacklistHint: '命中黑名单的 IP 访问任何入口都会直接返回 403。',
        blacklistPlaceholder: '每行一条，支持单个 IP 与 CIDR 段，例如：\n1.2.3.4\n10.0.0.0/8\n2001:db8::/32',
        blockMessage: '自定义拦截提示语（403 响应内容）',
        blacklistMessagePlaceholder: '留空使用默认提示语',
        ipv6Title: 'IPv6 拦截',
