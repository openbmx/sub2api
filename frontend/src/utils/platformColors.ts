...
const BADGE: Record<Platform, string> = {
  ...
  opencode: 'bg-amber-500/10 text-amber-600 border-amber-500/30 dark:text-amber-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  opencode: 'bg-amber-500/10 text-amber-600 dark:bg-amber-500/10 dark:text-amber-300',
...
const BORDER: Record<Platform, string> = {
  ...
  opencode: 'border-amber-500/20 dark:border-amber-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  opencode: 'border-amber-500/35 dark:border-amber-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  opencode: 'bg-gradient-to-r from-amber-400 to-amber-500',
...
const TEXT: Record<Platform, string> = {
  ...
  opencode: 'text-amber-600 dark:text-amber-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  opencode: 'bg-amber-500 text-white hover:bg-amber-600 active:bg-amber-700 dark:bg-amber-500/80 dark:hover:bg-amber-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  opencode: 'bg-amber-100 text-amber-700 dark:bg-amber-900/40 dark:text-amber-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  opencode: 'from-amber-500 to-amber-600',
