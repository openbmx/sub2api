<template>
  <div ref="rootRef" v-if="showUsageWindows">
    ...
    <!-- Multi-protocol providers (Kimi / Zhipu / DeepSeek / MiniMax / OpenCode):
         coding-plan quota or payg balance. Which of the two actually renders is
         decided by cnQuotaCellVisible / cnBalanceCellVisible, so a provider that
         exposes neither (OpenCode on payg) falls through to the placeholder. -->
...
import { cnQuotaCellVisible as cnQuotaCellVisibleFn, cnBalanceCellVisible as cnBalanceCellVisibleFn, isCNProviderPlatform } from './credentialsBuilder'
