...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/openbmx/sub2api/main/deploy/install.sh | bash
#
...
# Configuration
# This fork's own repository: releases installed here must be built from this
# tree. Overridable so a rename or a downstream fork needs no script edit.
...
Documentation=https://github.com/openbmx/sub2api
