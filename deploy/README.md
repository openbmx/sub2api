...
curl -sSL https://raw.githubusercontent.com/openbmx/sub2api/main/deploy/docker-deploy.sh -o docker-deploy.sh
...
1. Download the latest release from [GitHub Releases](https://github.com/openbmx/sub2api/releases)
